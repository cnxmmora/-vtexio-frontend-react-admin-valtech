...
export const messages = defineMessages({
  ...
  marioPageHeaderTitle: { id: 'admin/cookie-fortune.page.title' },
  ...
  cookieFortuneTableModalLabel: {
   ...
   cookieFortuneTableModalAlert: {
    id: 'admin/cookie-fortune.table.cookie.modal.alert',
  },
  ...
  cookieFortuneOrdersTableUpdateButton: {
    id: 'admin/navigation.update-button.label',
  },
